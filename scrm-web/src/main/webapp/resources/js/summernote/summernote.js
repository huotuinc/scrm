    ...
    var ImageDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var body = '<div class="form-group note-group-select-from-files">' +
                ...
                '<input class="note-image-input form-control" type="file" name="files" accept="image/jpa,image/jpeg,image/webp,image/bmp,image/png,image/svg,image/gif" multiple="multiple" />' +
                imageLimitation +
                '</div>' +
