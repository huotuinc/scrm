...
public class BusinessCardController extends MallBaseController{
    ...
    public String businessCard(HttpServletRequest request , long userId , Model model ){
        UserBusinessCard userBusinessCard = businessCardService.getUserBusinessCard(userId , getCustomerId(request));
        model.addAttribute("user", userBusinessCard);
