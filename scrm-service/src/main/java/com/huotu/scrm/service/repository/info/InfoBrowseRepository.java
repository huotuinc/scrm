...
public interface InfoBrowseRepository extends JpaRepository<InfoBrowse, Long>, JpaSpecificationExecutor<InfoBrowse> {
    ...
    //查询浏览记录
    @Query("select new com.huotu.scrm.service.entity.info.InfoBrowse(t.infoId,t.sourceUserId,t.readUserId,t.browseTime,u.weixinImageUrl,u.wxNickName,u.nickName, t.customerId,uc.wxNickName,ul.levelName)" +
